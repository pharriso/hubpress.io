...
image::https://cloudautomation.pharriso.co.uk/images/constructed_tower_inventory_source.png[]
...
image::https://cloudautomation.pharriso.co.uk/images/constructed_tower_inventory_groups.png[]
