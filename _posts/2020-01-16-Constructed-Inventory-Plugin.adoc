...
image::https://cloudautomation.pharriso.co.uk/images/constructued-1-tower-project.png[]
...
Now that we have a credential type in Ansible Tower, we can create a credential using this new type. This should 
