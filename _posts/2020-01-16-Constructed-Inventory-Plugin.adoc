...
You can see a group call sat6_demolab_local (underscore has replaced the fullstops) which it has constructed from the facts obtained by foreman inventory script.
