...
Delete the connector between Begin and End. Then Select the *Core* tab in the right hand pane. Under *Utilities*, drag the *Run Script* object onto the workflow canvas.


Workflow design - select core and dragt across utilities -> run script

Give it a name and paste script
